...
class Helpers:
	...
	def get_nearby_components(self, bug_id, graph_folder_path, screen_id, positionX, positionY, height, width, execution, destination, seq_id):
		execution_file = ""
		if destination=="TR":
			execution_file = "Data/data/TraceReplayer-Data/TR" + bug_id +"/Execution-" + str(int(execution)+1) + ".json"
		elif destination=="CS":
			if execution=="0":
	...
	def get_labels(self, comp_id_list, prev_node_match):
		q_label = []
